"""
Django settings for smartmaritime project.
...
#ALLOWED_HOSTS = ['smm-backend-im.onrender.com', 'localhost', '127.0.0.1']
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'smartmaritime.urls'
...
WSGI_APPLICATION = 'smartmaritime.wsgi.application'
